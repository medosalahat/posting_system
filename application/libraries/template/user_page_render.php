...
class User_page_render
{
    ...
    private function __GET_FILED()
    {
        ...
        return $this->___SET_DATA_BUY_INDEX($this->CI->post_md->__GET_NEWS_ME($this->CI->session_user->__GET_ID()) ,'post');
    }
    ...
    private function __SET_ID()
    {
        ...
        $this->ID = $this->CI->session_user->__GET_ID();
    }
