    ...
    <div class="col-xs-12 col-sm-4 col-md-3">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form role="search" class="" id="image_profile_form" method="post" enctype="multipart/form-data"
                      action="<?= base_url().'function/user/upload_new_image'?>">
                    ...
                    <button type="submit" id="image_profile" class="btn btn-default">Upload New Image
                    </button>
                </form>
            </div>
        </div>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <input type="text" class="form-control" id="name" value="<?= $MY_DATA[$T_USER[1]] ?>"
                       style="  margin-bottom: 15px;">
                <input type="text" class="form-control" id="mobile" value="<?= $MY_DATA[$T_USER[6]] ?>"
                       style="  margin-bottom: 15px;">
                <w class="clearfix"></w>
                <button class="btn btn-success" id="save_butn_name">save</button>
            </div>
        </div>
    </div>
    <div class="col-md-9">
        <div class="row post_user">
            <div class="col-md-12">
                <form role="form" class="form_user" id="form_post" method="post" action="<?= base_url().'function/user/add_post'?>">
                    <div class="form-group">
                        <textarea class="form-control" name="post" id="post" cols="12" placeholder="What's on your mind?"></textarea>

                    </div>
                    <button type="submit" class="btn btn-success post_button">Post</button>
